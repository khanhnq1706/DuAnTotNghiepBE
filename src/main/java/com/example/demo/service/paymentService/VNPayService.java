...
//        if(!bankCode.equals("VNPAYQR") && !bankCode.equals("VNBANK") && !bankCode.equals("INTCARD") ){
//            bankCode =null;
//        }
    ...
    public VNPayResponseDTO vnpayReturn()  {
        try {
            ...
            if (signValue.equals(vnp_SecureHash)) {
                ...
                boolean checkOrderId = fields.get("vnp_TxnRef").toString().equals(String.valueOf(orderNeedCheck.getIdOrder()));
                ...
                // Giả sử PaymnentStatus = 0 (pending) là trạng thái thanh toán của giao dịch khởi tạo chưa có IPN.
